        ...
        <v-container>
          <v-row justify="center" class="space">
            ...
            <v-item v-slot="{ active, toggle }">
              <v-card :color="active ? '#D5F0DB' : 'white'" :class="active ? 'borderme' : 'borderout'" class="d-flex align-center rounded-lg mx-2"
               dark height="170" @click="toggle" flat>
               <v-row>
                 <v-col cols="12" sm="12">
                  ...
                  <v-list-item-content>
                    ...
                    <v-list-item-subtitle :class="active ? 'green--text' : 'black--text'" class="caption mt-4">{{ category.title }}
